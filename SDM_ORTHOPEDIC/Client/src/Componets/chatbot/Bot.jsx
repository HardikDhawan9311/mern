...
//               <div className="flex justify-start mb-2">
//                 <div className="p-2 rounded-lg max-w-xs bg-gray-200 text-gray-800">
//                   {/* This is where you can show a typing indicator */}
//                   <span>Typing...</span>
//                 </div>
//               </div>
//             )}
...
const Chatbot = () => {
  ...
  // const displayBotMessage = (text) => {
  //   // Log the original bot message to ensure it's correct
  //   console.log("Full bot message received:", text);
  
  //   // Trim the text to remove any potential leading whitespace or non-visible characters
  //   text = text.trim();
  ...
  //   // Additional logging to inspect if there's anything wrong with the first character
